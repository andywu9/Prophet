import sys
import json
import lstm.buildModel as buildModel
import lstm.dataHelper as dataHelper
import numpy as np
import pandas as pd
...
def train_predict(train_file_arg):
	...
	parameter_file = '/Users/andy/virtualenvironment/ProphetVE/Prophet/prophet/lstm/trainingConfig.json'
